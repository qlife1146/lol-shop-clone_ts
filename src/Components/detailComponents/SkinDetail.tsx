...
import { Skin } from "../../data/useSkins";
...
export default function SkinDetail({ data }: Props) {
                    ...
                    <div className="champion-detail-info-purchase">
                        <div className="champion-detail-info">
                            <div className="champion-detail-title">
                                <h1>
                                    {/* {props.data[skinId - 1].name} */}
                                    {id && data[+skinId - 1].name}
                                </h1>
                            </div>
                            <div className="description">
                                <p>
                                    {/* {props.data[skinId - 1].championName} */}
                                    {id && data[+skinId - 1].championName}
                                    에게 새 스킨을 입혀주세요.
                                </p>
                            </div>
                        </div>
